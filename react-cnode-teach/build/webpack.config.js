...
module.exports = {
  ...
  output: {
    ...
    publicPath: "", //静态资源引用时的路径，如果其为空，那么就是得到app.hash.js(按上面的filename得来)，如果为现在设置的这样(publicPath: "/public",)，就是public/app.hash.js，非常有利于对文件的区分，要区分放到cdn里的文件的话，就设置为/cdn
  },
  module: {
      rules: [ //用于配置，使其能识别jsx
        {
